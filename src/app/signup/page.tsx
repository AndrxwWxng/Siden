    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-black text-white">
      ...
      >
        <div className="text-center opacity-0" style={{animation: 'fadeIn 0.5s 0.2s forwards'}}>
          <h1 className="text-4xl font-bold bg-gradient-to-r from-[#6366F1] to-[#8B5CF6] bg-clip-text text-transparent">Sign Up</h1>
          <p className="mt-2 text-[#AAAAAA]">Create your account</p>
        </div>
        ...
        >
          ...
          {message && (
            <div className="rounded-md bg-[#0B2D1A] border border-[#1D5A3A] p-4">
              <div className="text-sm text-[#6EE7B7]">{message}</div>
            </div>
          )}
        ...
        <div className="text-center text-sm opacity-0" style={{animation: 'fadeIn 0.5s 0.7s forwards'}}>
          <p className="text-[#AAAAAA]">
            ...
            <Link href="/signin" className="font-medium text-[#6366F1] hover:text-[#4F46E5] transition-colors duration-300 relative group">
              Sign in
