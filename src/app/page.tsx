  ...
  return (
    <div className="min-h-screen bg-[#121212] text-white flex flex-col">
      ...
      <main className="flex flex-col flex-grow">
        ...
        <section 
          ref={heroRef}
          className="flex flex-col items-center justify-center pt-16 md:pt-32 pb-24 md:pb-48 relative overflow-hidden"
        >
          ...
          <div className="container mx-auto px-4 md:px-8 lg:px-50 relative z-10">
            <div 
              className={`flex flex-col items-center text-center mb-8 md:mb-16 transition-all duration-1000 ${
                heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
            >
              <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 md:mb-6 leading-tight tracking-tight max-w-4xl">
                Build and orchestrate your AI agent team <span className="effortlessly-text">effortlessly</span>
              </h1>
              <p className="text-lg sm:text-xl md:text-2xl text-[#AAAAAA] max-w-2xl mx-auto mb-6 md:mb-10 px-4 sm:px-0">
              ...
              <div className="flex flex-col sm:flex-row gap-4 mt-4 w-full sm:w-auto px-4 sm:px-0">
                <Link 
                  href="/dashboard" 
                  className="px-6 sm:px-8 py-3 bg-[#6366F1] hover:bg-[#4F46E5] text-white font-medium rounded transition-all duration-200 flex items-center justify-center min-w-[180px]"
                >
                  Start building
                </Link>
                <Link 
                  href="/pricing" 
                  className="px-6 sm:px-8 py-3 bg-transparent border border-[#2e2e2e] hover:border-[#6366F1] text-white font-medium rounded transition-all duration-200 flex items-center justify-center min-w-[180px]"
                >
                  View pricing
                </Link>
              </div>
            ...
            <div 
              className={`relative w-full max-w-5xl mx-auto h-[300px] sm:h-[400px] md:h-[500px] lg:h-[620px] mt-8 md:mt-16 transition-all duration-1000 delay-300 ${
        ...
        <section 
          ref={logosRef}
          className="py-12 md:py-24 border-t border-[#1e1e1e] w-full max-w-full overflow-hidden"
        >
          <div className="container mx-auto px-4 md:px-8 lg:px-50">
            <p className={`text-center text-[#AAAAAA] uppercase text-sm tracking-wider mb-6 md:mb-10 transition-all duration-700 ${
              logosVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'
            }`}>
              Powered by builders
            </p>
            <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4 md:gap-8 items-center justify-items-center">
              {[
                ...
                <div 
                  key={i} 
                  className={`relative h-6 sm:h-8 w-20 sm:w-28 transition-all duration-700 hover:opacity-100 ${
        ...
        <section 
          ref={productRef}
          className="py-12 md:py-24 bg-[#121212]"
        >
          <div className="container mx-auto px-4 md:px-8 lg:px-50">
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 md:gap-12">
              ...
              >
                ...
                <p className="text-base sm:text-lg text-[#AAAAAA] mb-6 md:mb-8 leading-relaxed">
                ...
                <div className="space-y-6 md:space-y-8">
                  {[
                    ...
                    >
                      <div className="flex-shrink-0 flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-gradient-to-br from-[#6366F1] to-[#4F46E5] text-white font-bold mr-3 md:mr-4 shadow-lg shadow-[#6366F1]/20 group-hover:shadow-[#6366F1]/30 transition-all duration-300">
                        {i + 1}
                      </div>
                      <div>
                        <h3 className="text-lg sm:text-xl font-semibold mb-1 sm:mb-2 text-white">{step.title}</h3>
                        <p className="text-sm sm:text-base text-[#AAAAAA] leading-relaxed">{step.desc}</p>
                      </div>
                    </div>
                  ))}
                </div>
                ...
                >
                  <Link 
                    href="/dashboard" 
                    className="px-6 sm:px-8 py-3 bg-[#6366F1] hover:bg-[#4F46E5] text-white font-medium rounded transition-all duration-200 flex items-center w-fit group"
                  >
                    Start building now
              ...
              <div 
                className={`w-full md:w-1/2 h-[300px] sm:h-[400px] md:h-[500px] relative transition-all duration-1000 delay-500 mt-8 md:mt-0 ${
                  productVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-20'
                }`}
              >
        ...
        <section className="py-16 md:py-32 bg-[#121212] w-full max-w-full overflow-hidden">
          <div className="container mx-auto px-4 md:px-8 lg:px-50">
            <div className="max-w-3xl mx-auto text-center mb-10 md:mb-16">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 md:mb-4"><span className="effortlessly-text"> Powerful Integrations</span></h2>
              <p className="text-base sm:text-lg text-[#AAAAAA] px-2 sm:px-0">
            ...
            <div className="max-w-6xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                {/* GitHub Integration */}
                <div className="bg-[#1B1A19] rounded-lg p-4 sm:p-6 border border-[#2a2a2a] hover:border-[#6366F1] transition-all duration-300 group h-full flex flex-col">
                  <div className="flex items-start mb-3 sm:mb-4">
                    <div className="h-12 sm:h-16 w-12 sm:w-16 mr-3 sm:mr-4 flex items-center justify-center">
                      <svg className="w-10 sm:w-14 h-10 sm:h-14 text-white" viewBox="0 0 1024 1024" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-medium text-[#6366F1]">GitHub</h3>
                      <p className="text-xs sm:text-sm text-[#AAAAAA]">Code & Version Control</p>
                    </div>
                  </div>
                  <div className="mt-2">
                    <p className="text-xs sm:text-sm text-[#AAAAAA]">Enable your agents to manage repositories, create pull requests, and review code changes autonomously.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#1B1A19] rounded-lg p-4 sm:p-6 border border-[#2a2a2a] hover:border-[#6366F1] transition-all duration-300 group h-full flex flex-col">
                  <div className="flex items-start mb-3 sm:mb-4">
                    <div className="h-12 sm:h-16 w-12 sm:w-16 mr-3 sm:mr-4 flex items-center justify-center">
                      <svg className="w-10 sm:w-14 h-10 sm:h-14" viewBox="0 0 2447.6 2452.5" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-medium text-[#6366F1]">Slack</h3>
                      <p className="text-xs sm:text-sm text-[#AAAAAA]">Team Communication</p>
                    </div>
                  </div>
                  <div className="mt-2">
                    <p className="text-xs sm:text-sm text-[#AAAAAA]">Let your agents communicate directly with your team in Slack channels, providing updates and responding to requests.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#1B1A19] rounded-lg p-4 sm:p-6 border border-[#2a2a2a] hover:border-[#6366F1] transition-all duration-300 group h-full flex flex-col">
                  <div className="flex items-start mb-3 sm:mb-4">
                    <div className="h-12 sm:h-16 w-12 sm:w-16 mr-3 sm:mr-4 flex items-center justify-center">
                      <svg className="w-10 sm:w-14 h-10 sm:h-14" viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg">
                        <g id="_x31__stroke">
                          <g id="Google">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-medium text-[#6366F1]">Google</h3>
                      <p className="text-xs sm:text-sm text-[#AAAAAA]">Docs, Sheets & Calendar</p>
                    </div>
                  </div>
                  <div className="mt-2">
                    <p className="text-xs sm:text-sm text-[#AAAAAA]">Integrate with Google to let agents draft documents, analyze spreadsheets, and manage schedules.</p>
                  </div>
                </div>
                ...
                <div className="bg-[#1B1A19] rounded-lg p-4 sm:p-6 border border-[#2a2a2a] hover:border-[#6366F1] transition-all duration-300 group h-full flex flex-col">
                  <div className="flex items-start mb-3 sm:mb-4">
                    <div className="h-12 sm:h-16 w-12 sm:w-16 mr-3 sm:mr-4 flex items-center justify-center">
                      <svg className="w-10 sm:w-14 h-10 sm:h-14" viewBox="6.20856283 .64498824 244.26943717 251.24701176" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div>
                      <h3 className="text-lg sm:text-xl font-medium text-[#6366F1]">HubSpot</h3>
                      <p className="text-xs sm:text-sm text-[#AAAAAA]">CRM & Marketing</p>
                    </div>
                  </div>
                  <div className="mt-2">
                    <p className="text-xs sm:text-sm text-[#AAAAAA]">Connect your agents to HubSpot for lead management, customer communication, and marketing campaign analytics.</p>
                  </div>
                </div>
              </div>
